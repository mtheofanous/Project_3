...
def load_gesture(gesture='random', path='data_path_1'):
    """
    Returns a random image from the dataset folder given a gesture name.
...
def show_random_image(letter, data_dir='data_path_1'):
    """
    Displays the single image from the dataset for a given letter and shows hand landmarks if present.
